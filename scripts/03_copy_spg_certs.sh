...
aws s3 cp s3://tf-eu-west-2-hmpps-eng-dev-certificates-private-s3bucket/official-data/hmpps-delius-prod/current/spg-psn-ext-tls/spgw-ext-psn.probation.service.justice.gov.uk.public-certificate.pem /etc/pki/tls/private/spgw-int-psn.probation.service.justice.gov.uk.key
aws s3 cp s3://tf-eu-west-2-hmpps-eng-dev-certificates-private-s3bucket/official-data/hmpps-delius-prod/current/spg-psn-ext-tls/spgw-ext-psn.probation.service.justice.gov.uk.key /etc/pki/tls/certs/privateca.probation.service.justice.gov.uk.public-certificate.pem

# delius-prod - spg-psn-int-tls
aws s3 cp s3://tf-eu-west-2-hmpps-eng-dev-certificates-private-s3bucket/official-data/hmpps-delius-prod/current/spg-psn-int-tls/spgw-int-psn.probation.service.justice.gov.uk.public-certificate.pem /etc/pki/tls/certs/spgw-ext-psn.probation.service.justice.gov.uk.public-certificate.pem
aws s3 cp s3://tf-eu-west-2-hmpps-eng-dev-certificates-private-s3bucket/official-data/hmpps-delius-prod/current/spg-psn-int-tls/spgw-int-psn.probation.service.justice.gov.uk.key /etc/pki/tls/private/spgw-ext-psn.probation.service.justice.gov.uk.key
